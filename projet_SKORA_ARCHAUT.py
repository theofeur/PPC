...
def info(n):
    ...
    if infor == 1:
        ...
        while couleur not in ["red","green","blue","yellow","white"]:
            try:
                couleur = str (input("Choisissez la couleur que vous souhaitez révéler parmi les couleurs disponibles:"))
            except ValueError:
